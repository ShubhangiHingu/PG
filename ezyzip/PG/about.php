			...
			<section class="section-padding">
				<div class="container">
					<div class="row showcase-section">
						...
						<div class="col-md-6">
							<div class="about-text">
								<h3>What we<span class="color"> Do ?</span></h3>
								<hr style="border-top: 2px solid black;"/>
								<p align="justify"> We put together a list of places where our guests can stay as a PG. This is done based on listings on our site by homeowners. We ensure that not only are they a safe home for the guest but the guest too is safe for them. These places can be searched based on locality, budget, need, and multiple other filters. Find the perfect PG stay or guest with us.</p>
								<p align="justify">To meet our aim, we eliminate the two major problems a guest or host may face. The first of these is a lack of information for anyone new in a city. Our site will list all the information you can seek not just about the house and homeowners but also the locality and other aspects.</p>
							</div>
						</div>
						<div class="col-md-6">
							<img src="img/bg_2.jpg" alt="showcase image" width="500px;" height="272px;" style="    margin-top: 59px;
    margin-left: 43px;">
						</div>
					</div>
				</div>
